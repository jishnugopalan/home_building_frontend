...
class InteriorProfileList extends StatefulWidget {
  @override
  _InteriorProfileListState createState() => _InteriorProfileListState();
}

class _InteriorProfileListState extends State<InteriorProfileList> {
  WorkService service=WorkService();
  List<dynamic> data = [];
  getAllInteriorDesigners() async {
    try{
      final Response res=await service.getAllInterior();
      print(res);
