...
class ArchitectProfileList extends StatefulWidget {
  @override
  _ArchitectProfileListState createState() => _ArchitectProfileListState();
}

class _ArchitectProfileListState extends State<ArchitectProfileList> {
  WorkService service=WorkService();
  List<dynamic> data = [];
  getAllInteriorDesigners() async {
    try{
      final Response res=await service.getAllArchitect();
      print(res);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Architect Profiles')),
